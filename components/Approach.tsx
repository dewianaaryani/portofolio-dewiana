  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="We'll collaborate to map out your webiste&apos;s goals, target audience, and key functionalities. We'll also help you define your branding and visual identity, ensuring that your website stands out from the competition."
        > 
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Launch and Maintenance" icon={<AceternityIcon order="Phase 3" />}
            description="We'll collaborate to map out your webiste&apos;s goals, target audience, and key functionalities. We'll also help you define your branding and visual identity, ensuring that your website stands out from the competition."
        >
          <CanvasRevealEffect
            animationSpeed={3}
